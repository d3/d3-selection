...
Selection.prototype = {
  ...
  dispatch: function(type, detail) {
    ...
    function dispatchConstant() {
      return new windowOf(this).CustomEvent(type, detail);
    }

    function dispatchFunction() {
      return new windowOf(this).CustomEvent(type, detail.apply(this, arguments));
    }

    return this.each(typeof detail === "function"
        ? dispatchFunction
        : dispatchConstant);
  },
