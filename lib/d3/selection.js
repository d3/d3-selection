...
Selection.prototype = {
  ...
  filter: function(filter) {
    ...
    visit(this, function(nodes, i) {
      ...
      if (filter.apply(node, args)) parent.push(node);
    }, function() {
      parent = ancestors.pop();
    });
  ...
  data: function(value, key) {
    if (!arguments.length) {
      ...
      visit(this, noop, function(d) { data[++i] = d; }, noop);
      return data;
    }
    ...
    this._root = visit(this, function(nodes, i) {
  ...
  each: function(callback) {
    visit(this, noop, function(node, i, args) { callback.apply(node, args); }, noop);
    return this;
  },
  ...
  empty: function() {
    return visit(this, noop, function() { return true; }, noop);
  },

  nodes: function() {
    var nodes = new Array(this.size()), i = -1;
    visit(this, noop, function(node) { nodes[++i] = node; }, noop);
    return nodes;
  },

  node: function() {
    return visit(this, noop, function(node) { return node; }, noop);
  },

  size: function() {
    var size = 0;
    visit(this, noop, function() { ++size; }, noop);
    return size;
  }
};
  ...
  function recurse(nodes, depth) {
    ...
    if (depth) {
      while (++i < n) {
        ...
        stack[stack0] = node._parent.__data__, stack[stack1] = i;
        previsit(node, i);
        if (recurse(node, depth)) return true;
        postvisit();
      }
    }
      ...
      while (++i < n) {
        if (node = nodes[i]) {
          stack[stack0] = node.__data__, stack[stack1] = i;
          if (value = visit(node, i, stack)) return true;
        }
      }
    }
  }
