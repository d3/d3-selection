...
Selection.prototype = {
  ...
  event: function(type, listener, capture) {
    ...
    function add() {
      ...
      var l = wrap(listener, ancestors, arguments);
      remove.call(this);
...
function listenerOf(listener, ancestors, args) {
  return function(e) {
    var i = ancestors.length, o = global.d3.event; // Events can be reentrant (e.g., focus).
...
function filteredListenerOf(listener, ancestors, args) {
  listener = listenerOf(listener, ancestors, args);
  return function(e) {
