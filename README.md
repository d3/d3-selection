...
If you use Babel, Webpack, or another ES6-to-ES5 transpiler, be aware that the value of d3.event changes during an event! An import of d3.event must therefore be a true [live binding](http://www.2ality.com/2015/07/es6-module-exports.html) and not a copy. You may need to configure Babel or Webpack to import from D3’s ES6 modules directly, rather than from the generated UMD bundle; not all bundlers observe [jsnext:main](https://github.com/rollup/rollup/wiki/jsnext:main). Also beware of conflicts with the [*window*.event](https://developer.mozilla.org/en-US/docs/Web/API/Window/event) global.
