...
it("select.selectChild(…) selects the first (matching) child", jsdom("<h1><span>hello</span>, <span>world<span>!</span></span></h1>", () => {
...
it("selectAll.selectChild(…) selects the first (matching) child", jsdom("<div><span>hello</span>, <span>world<span>!</span></span></div><div><span>hello2</span>, <span>world2<span>!2</span></span></div>", () => {
...
it("select.selectChildren(…) selects the matching children", jsdom("<h1><span>hello</span>, <span>world<span>!</span></span></h1>", () => {
  const s = select(document).select("h1");
...
it("selectAll.selectChildren(…) selects the matching children", jsdom("<div><span>hello</span>, <span>world<span>!</span></span></div><div><span>hello2</span>, <span>world2<span>!2</span></span></div>", () => {
  const s = select(document).selectAll("div");
  assert(s.selectChildren("*") instanceof selection);
  assert.strictEqual(s.selectChildren("*").text(), "hello");
